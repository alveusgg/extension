import { useCallback, useEffect, useRef, type Ref, useState } from "react";
      ...
      >
          ...
          <>
            ...
            <div className="mb-2 scrollbar-thin flex flex-auto flex-col gap-1 overflow-y-auto p-2 scrollbar-thumb-alveus-green scrollbar-track-alveus-green-900">
              ...
              {ambassador.fact && (
                <div>
                  <Tooltip
                    text="Click to see a fun fact about this ambassador!"
                    maxWidth="18rem"
                    fontSize="0.9rem"
                  >
                    <div className="inline-flex items-center gap-2">
                ...
                <p>
                  ...
                  ambassador.species.lifespan.wild !== undefined ? (
                    <>
                      ...
                      {stringifyLifespan(ambassador.species.lifespan.wild)}{" "}
                      years
                    </>
                  ) : (
                    "Unknown"
        ...
        {flipped && (
          <div className={className}>
            ...
            <p className="mt-2 px-4 text-center text-lg text-alveus-green-400">
              Did you know?
            </p>
            ...
            <div className="mt-3 flex items-center justify-center">
              <button
                className="mb-3 rounded bg-alveus-green-400 px-2 py-2 text-white transition-colors hover:bg-highlight active:bg-highlight"
                onClick={() => {
                  window.open(
                    `https://www.alveussanctuary.org/ambassadors/${camelToKebab(
                      ambassadorKey,
                    )}`,
                    "_blank",
                  );
                ...
                type="button"
              >
                <p className="text-alveus-green-900">
                  Learn more on the Alveus Sanctuary website{" "}
                  <IconExternal className="mb-0.5 inline-block" size={12} />
                </p>
              </button>
            </div>
